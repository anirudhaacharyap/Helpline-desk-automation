...
public class PriorityEngine {
    ...
    public static void main(String[] args) {
        System.out.println("=== PriorityEngine Test ===");
        System.out.println("Server down + data loss : " +
                assignPriority("Server down!", "We have data loss in production"));
        System.out.println("Login not working       : " +
                assignPriority("Login failed", "User login is not working"));
        System.out.println("Slow performance        : " +
                assignPriority("App is slow", "Intermittent performance issues"));
        System.out.println("General question        : " +
                assignPriority("How to reset?", "I want to change my profile picture"));
    }
}
